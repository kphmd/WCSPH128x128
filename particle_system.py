...
class ParticleSystem:
    def __init__(self, res):
        ...
        # grid_node = ti.root.sparse(index, self.grid_num)
        ...
        # cell_node = grid_node.sparse(cell_index, self.particle_max_num_per_cell)
